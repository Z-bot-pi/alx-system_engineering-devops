...
A project which is the first of two that introduce networking concepts. Within the project,there are questions and I did write bash scripts while learning about the OSI model, LAN and WAN networks, and TCP/UDP data transfer protocols.
...
## Acknowledging
ALX SE is an online course,full-stack software
engineering program that prepares students for careers in the tech industry
using project-based peer learning. For more information, visit
[this link](https://www.alxafrica.com/programmes/).
